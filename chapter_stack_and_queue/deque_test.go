...
// BenchmarkArrayDeque 1.033 ns/op in Mac M1 Pro
func BenchmarkArrayDeque(b *testing.B) {
	deque := newArrayDeque(1000)
	// use b.N for looping
	for i := 0; i < b.N; i++ {
		deque.pushLast(777)
	}
...
// BenchmarkLinkedListDeque 51.57 ns/op in Mac M1 Pro
